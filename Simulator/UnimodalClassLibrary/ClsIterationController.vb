...
Public Class ClsIterationController
    ...
    Public Sub SetDefaultUserData()
        ...
        With MyForm
            ...
            'Set TrabParameterA to the Default of FormulaParameter.Range
            DS.ParameterA = DS.FormulaParameter.DefaultValue
            Dim TrbValue As Integer = CInt((DS.ParameterA - DS.FormulaParameter.Range.A) * 999 / DS.FormulaParameter.Range.IntervalWidth + 1)
    ...
    Private Function IsUserDataOK() As Boolean
        With MyForm
            ...
            Dim CheckParameter = New ClsCheckUserData(.TxtParameterA, DS.FormulaParameter.Range)

...
Public Class FrmCDiagram
    ...
    'Only the C-Parameter Intervall is adapted
    'because with more than one Value-Parameter
    'a selection of one of those doesn't make sense
    ...
    Private Sub SetDefaultValues()
        ...
        SetMyValueParameterByValue(MyValueParameters.Item(0))
    ...
    Private Sub PicDiagram_MouseMove(ByVal sender As Object, ByVal e As MouseEventArgs) Handles PicDiagram.MouseMove
        ...
        If IsMousedown Then
            ...
            UserSelectionEndpoint.Y = PicDiagram.Height

...
Partial Class FrmMain
    ...
    Private Sub InitializeComponent()
        ...
        MnuMain.Items.AddRange(New ToolStripItem() {MnuLanguage, MnuBilliard, MnuGrowthModels, MnuComplexIteration, MnuMechanics, Mnu3DAttractors, MnuFractals, MnuDocumentation, MnuTest})
        ...
        ' Mnu3DAttractors
        ' 
        Mnu3DAttractors.DropDownItems.AddRange(New ToolStripItem() {MnuStrangeAttractors, MnuBifurcation})
        Mnu3DAttractors.Name = "Mnu3DAttractors"
        Mnu3DAttractors.Size = New Size(85, 20)
        Mnu3DAttractors.Text = "3DAttractors"
        ' 
    ...
    Friend WithEvents Mnu3DAttractors As ToolStripMenuItem

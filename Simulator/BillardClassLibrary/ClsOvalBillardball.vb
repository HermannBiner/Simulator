'This class contains all Properties of the Billard Ball on an Oval Billard Table
...
Public Class ClsOvalBillardball
    ...
    Private Function SetUserStartposition(Mouseposition As Point) As Decimal
        ...
        'this startposition is still on the mouseposition (and not on the border of the Ellipse)
    ...
    Private Function ParameterOfNextHitPoint(t As Decimal, Phi As Decimal) As Decimal
        ...
        If Not IsIntersectionFound Then
            ...
            'Ther must be an intersection with the Ellipse
            'Dicriminant
            ...
            If DB * DB - DA * DC >= 0 Then
                ...
                If Math.Abs(u) > 0.000001 Then
                    ...
                    'Is this IntersectionPoint really part of the left half-Ellipse
        ...
        Else
            ...
            'Calculate the Paraameter T according to the Intersection Point

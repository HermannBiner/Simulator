...
Public MustInherit Class ClsUnitRootAbstract
    Implements IPolynom
    ...
    Public WriteOnly Property Procotol As ListBox Implements IPolynom.Procotol
    ...
    Public Sub Iteration(Startpoint As Point) Implements IPolynom.Iteration
        ...
        Do While i <= MyDeepness And MyBrush Is Brushes.White

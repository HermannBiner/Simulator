...
Public Class FrmJulia
    ...
    Private Sub FrmJuliaSet_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        AdjustLayout()
    End Sub
    ...
    Private Sub FrmJulia_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
        If IsFormLoaded Then
